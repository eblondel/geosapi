...
>**GeoServer API doc**: http://docs.geoserver.org/stable/en/user/rest/api/coveragestores.html
...
>**GeoServer API doc**: http://docs.geoserver.org/stable/en/user/rest/api/coverages.html
