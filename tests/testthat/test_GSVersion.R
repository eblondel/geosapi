...
test_that("geoserver versions",{
  ...
  expect_equal(gsVersion$version, "2.10.3")
  ...
  expect_true(gsVersion$lowerThan("2.10.4"))
  ...
  expect_false(gsVersion$greaterThan("2.10.4"))
  expect_false(gsVersion$greaterThan("3.0.0"))
  expect_false(gsVersion$greaterThan("2.10.3"))
  expect_false(gsVersion$lowerThan("2.10.3"))
  expect_true(gsVersion$equalTo("2.10.3"))
})
