...
test_that("geoserver versions",{
  ...
  expect_equal(gsVersion$version, "2.11.0")
  ...
  expect_true(gsVersion$lowerThan("2.11.1"))
  ...
  expect_false(gsVersion$greaterThan("2.11.1"))
  expect_false(gsVersion$greaterThan("3.0.0"))
  expect_false(gsVersion$greaterThan("2.11.0"))
  expect_false(gsVersion$lowerThan("2.11.0"))
  expect_true(gsVersion$equalTo("2.11.0"))
})
