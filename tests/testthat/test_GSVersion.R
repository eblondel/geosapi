...
test_that("geoserver versions",{
  ...
  expect_equal(gsVersion$version, "2.10.2")
  ...
  expect_true(gsVersion$lowerThan("2.10.3"))
  ...
  expect_false(gsVersion$lowerThan("2.10.2"))
  expect_true(gsVersion$equalTo("2.10.2"))
})
