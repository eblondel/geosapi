...
modelling a GeoServer ImageMosaic CoverageStore
...
- [`GSImageMosaicCoverageStore$new()`](#method-GSImageMosaicCoverageStore-new)

- [`GSImageMosaicCoverageStore$clone()`](#method-GSImageMosaicCoverageStore-clone)
