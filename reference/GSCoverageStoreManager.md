...
#>     uploadArcGrid: function (ws, cs, endpoint = "file", filename, configure = "first", 
#>     uploadCoverage: function (ws, cs, endpoint = "file", extension, filename, configure = "first", 
#>     uploadGeoTIFF: function (ws, cs, endpoint = "file", filename, configure = "first", 
#>     uploadImageMosaic: function (ws, cs, endpoint = "file", filename, configure = "first", 
#>     uploadWorldImage: function (ws, cs, endpoint = "file", filename, configure = "first", 
