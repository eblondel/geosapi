...
modelling a GeoServer GeoTIFF CoverageStore
...
- [`GSGeoTIFFCoverageStore$new()`](#method-GSGeoTIFFCoverageStore-new)

- [`GSGeoTIFFCoverageStore$clone()`](#method-GSGeoTIFFCoverageStore-clone)
