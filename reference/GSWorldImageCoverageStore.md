...
modelling a GeoServer WorldImage CoverageStore
...
- [`GSWorldImageCoverageStore$new()`](#method-GSWorldImageCoverageStore-new)

- [`GSWorldImageCoverageStore$clone()`](#method-GSWorldImageCoverageStore-clone)
