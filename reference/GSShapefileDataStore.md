...
modelling a GeoServer Shapefile dataStore
...
- [`GSShapefileDataStore$new()`](#method-GSShapefileDataStore-new)

- [`GSShapefileDataStore$setUrl()`](#method-GSShapefileDataStore-setUrl)

- [`GSShapefileDataStore$setCharset()`](#method-GSShapefileDataStore-setCharset)

- [`GSShapefileDataStore$setCreateSpatialIndex()`](#method-GSShapefileDataStore-setCreateSpatialIndex)

- [`GSShapefileDataStore$setMemoryMappedBuffer()`](#method-GSShapefileDataStore-setMemoryMappedBuffer)

- [`GSShapefileDataStore$setCacheReuseMemoryMaps()`](#method-GSShapefileDataStore-setCacheReuseMemoryMaps)

- [`GSShapefileDataStore$setDefautConnectionParameters()`](#method-GSShapefileDataStore-setDefautConnectionParameters)

- [`GSShapefileDataStore$clone()`](#method-GSShapefileDataStore-clone)
